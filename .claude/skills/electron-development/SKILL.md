...
description: "Desenvolvimento de app desktop Electron em nível sênior — IPC seguro, contextIsolation e sandbox, scripts de preload, arquitetura multi-processo, hardening de segurança, estado entre processos, packaging com electron-builder, code signing e auto-update, além de debugging e testes E2E. Usar ao criar, proteger, empacotar, distribuir ou depurar um app Electron (ex.: o cliente Disneia em client/)."
risk: safe
source: community
